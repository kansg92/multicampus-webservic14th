...
public class ProductDao implements Dao<Integer, ProductVO> {
	...
	public List<ProductVO> select() {
		...
		list.add(new ProductVO(200, "pants2", 20000));
		list.add(new ProductVO(300, "pants3", 30000));
		list.add(new ProductVO(400, "pants4", 40000));
		list.add(new ProductVO(500, "pants5", 50000));
		return list;
	}
